...
namespace GBC_Ticketing.Areas.Identity.Pages.Account.Manage
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            user.DateOfBirth = Input.DateOfBirth.HasValue
                ...
                : null;
            user.ProfilePictureUrl = string.IsNullOrWhiteSpace(Input.ProfilePictureUrl) ? null : Input.ProfilePictureUrl.Trim();
